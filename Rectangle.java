...
public class Rectangle
{
  ...
  {
    double val;
    if (Rectangle.longeur/Rectangle.largeur > Rectangle.largeur/Rectangle.longeur)
      val = Rectangle.longeur/Rectangle.largeur;
    else
      val= Rectangle.largeur/Rectangle.longeur;
    Rectangle.police = new Font("Roboto", Font.PLAIN, (int)( 14 * zoom * val));
  }

  public static int getLargeur()  { return Rectangle.largeur;  }
  public static int getLongeur()  { return Rectangle.longeur;  }
  public static int getDecalage() { return Rectangle.decalage; }
}
